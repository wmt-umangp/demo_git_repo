...
// let age_above= data.filter(data => data.age >25);
// // console.log(age_above);
// document.getElementById('age_filter').innerHTML=age_above.map(e => "Name: "+e.name + "<br>" +"Age: "+ e.age+"<br><br>");
// console.log(age_above); 

//filter by male and female
// let male_data=;

// console.log(male_data.map(e => `${e.name} ${e.gender}`),"he");
document.getElementById('male_data').innerHTML = data.filter(data=>data.gender==="male").map(e => { return `<div>${e.name}</div>`});
