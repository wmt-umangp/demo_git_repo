...
document.getElementById('age_filter').innerHTML=data.filter(data => data.age >25).map(e => "Name: "+e.name + "<br>" +"Age: "+ e.age+"<br><br>").join('');

//filter and count by male.
document.getElementById('male_data').innerHTML = data.filter(data=>data.gender=='male').map(e=>"Name: "+e.name + "<br>" +"Age: "+ e.gender+"<br><br>").join('');
...
document.getElementById('female_data').innerHTML = data.filter(data=>data.gender=='female').map(e=>"Name: "+e.name + "<br>" +"Age: "+ e.gender+"<br><br>").join('');
...
//tag with dolor
document.getElementById('dolor_tag').innerHTML=data.filter(e=>e.tags.some(v=>v=="dolor")).map(element=> `Name:${element.name}<br><br>`).join('');


// let result = data.reduce((a,curr) =>{ 
//   // return curr.balance
//  let res=curr.balance.split('$').join('');
//  let r=res.split(',').join('');
//  return res+r;
// },0);
// console.log(result);